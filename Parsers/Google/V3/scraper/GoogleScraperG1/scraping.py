...
from GoogleScraperG1.database import db_Proxy
from GoogleScraperG1.output_converter import store_serp_result
from GoogleScraperG1.parsing import get_parser_by_search_engine, parse_serp
import logging
...
def get_base_search_url_by_search_engine(config, search_engine_name, search_mode):
    ...
    print("specific_base_url", specific_base_url)
    print("specific_base_url" ,specific_base_url)    
    print()
    print()
    print()
...
#     if("yandex" in str(specific_base_url)):
#         specific_base_url = "https://yandex.ru/images/search?&recent=7D".format(config.get("time_filter", ""))
...
from GoogleScraperG1.http_mode import HttpScrape
from GoogleScraperG1.selenium_mode import get_selenium_scraper_by_search_engine_name
