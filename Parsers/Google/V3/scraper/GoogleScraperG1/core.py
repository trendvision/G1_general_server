...
import os
import queue
from GoogleScraperG1.log import setup_logger
from GoogleScraperG1.commandline import get_command_line
from GoogleScraperG1.database import ScraperSearch, SERP, Link, get_session, fixtures
from GoogleScraperG1.proxies import parse_proxy_file, get_proxies_from_mysql_db, add_proxies_to_db
from GoogleScraperG1.caching import CacheManager
from GoogleScraperG1.config import get_config
from GoogleScraperG1.scrape_jobs import default_scrape_jobs_for_keywords
from GoogleScraperG1.scraping import ScrapeWorkerFactory
from GoogleScraperG1.output_converter import init_outfile
from GoogleScraperG1.async_mode import AsyncScrapeScheduler
import logging
from GoogleScraperG1.utils import get_base_path
import GoogleScraperG1.config
...
def main(return_results=False, parse_cmd_line=True, config_from_dict=None):
    ...
    if config.get('version'):
        from GoogleScraperG1.version import __version__
        print(__version__)
        return
    ...
    if search_engine_name:
        from GoogleScraperG1.selenium_mode import check_detection
    ...
    if config.get('shell', False):
        ...
        namespace['SERP'] = SERP
        namespace['Link'] = Link
        namespace['Proxy'] = GoogleScraperG1.database.Proxy
    ...
    from GoogleScraperG1.output_converter import close_outfile
    close_outfile()
